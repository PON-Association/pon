...
declare const Client: typeof IgniteClient & import("./helpers").Constructor<{
    ...
    PonPon: {
        query: import("./pon.pon/rest").Api<unknown>;
        tx: {
            sendParams({ value, fee, memo }: {
                value: import("./pon.pon/module").Params;
                fee?: import("@cosmjs/amino").StdFee;
                memo?: string;
            }): Promise<import("@cosmjs/stargate").DeliverTxResponse>;
            sendMsgUpdateParams({ value, fee, memo }: {
                value: import("./pon.pon/module").MsgUpdateParams;
                fee?: import("@cosmjs/amino").StdFee;
                memo?: string;
            }): Promise<import("@cosmjs/stargate").DeliverTxResponse>;
            sendQueryParamsRequest({ value, fee, memo }: {
                value: import("./pon.pon/module").QueryParamsRequest;
                fee?: import("@cosmjs/amino").StdFee;
                memo?: string;
            }): Promise<import("@cosmjs/stargate").DeliverTxResponse>;
            sendGenesisState({ value, fee, memo }: {
                value: import("./pon.pon/module").GenesisState;
                fee?: import("@cosmjs/amino").StdFee;
                memo?: string;
            }): Promise<import("@cosmjs/stargate").DeliverTxResponse>;
            sendMsgUpdateParamsResponse({ value, fee, memo }: {
                value: import("./pon.pon/module").MsgUpdateParamsResponse;
                fee?: import("@cosmjs/amino").StdFee;
                memo?: string;
            }): Promise<import("@cosmjs/stargate").DeliverTxResponse>;
            sendQueryParamsResponse({ value, fee, memo }: {
                value: import("./pon.pon/module").QueryParamsResponse;
                fee?: import("@cosmjs/amino").StdFee;
                memo?: string;
            }): Promise<import("@cosmjs/stargate").DeliverTxResponse>;
            params({ value }: {
