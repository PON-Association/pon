...
export { QueryAllowancesByGranterRequest, GenesisState, Grant, MsgPruneAllowancesResponse, MsgGrantAllowanceResponse, MsgPruneAllowances, MsgGrantAllowance, QueryAllowancesResponse, QueryAllowancesByGranterResponse, BasicAllowance, PeriodicAllowance, AllowedMsgAllowance, QueryAllowanceRequest, QueryAllowanceResponse, QueryAllowancesRequest, MsgRevokeAllowance, MsgRevokeAllowanceResponse };
