...
func initRootCmd(
	...
	rootCmd.AddCommand(
		...
		genutilcli.CollectGenTxsCmd(banktypes.GenesisBalancesIterator{}, app.DefaultNodeHome, basicManager[genutiltypes.ModuleName].(genutil.AppModuleBasic).GenTxValidator, txConfig.SigningContext().ValidatorAddressCodec()),
	)
